...
How to run
1. Open `index.html` directly in a modern browser (Chrome/Edge/Firefox). Some browsers restrict local file resources, but this project is pure client-side so it should work by opening the file.
